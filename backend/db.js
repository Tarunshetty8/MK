...
async function seedMockData() {
    try {
        ...
        if (parseInt(prodRes[0].count) >= 0) { // We update existing or insert new to ensure new branding is present
            ...
            await pool.promise().query(`REPLACE INTO Products (id, name, category, price, flash_sale_price, is_flash_sale, stock_quantity, is_active, expiry_date, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, ['1', 'House Blend Coffee Beans 250g', 'Beverages', 12.50, 9.99, 1, 24, 1, '2026-12-31', '["https://images.squarespace-cdn.com/content/v1/655a0aefcc06663665faecbe/8f7df1de-71b0-431a-b075-82ee88982569/img-5.jpg?format=1500w"]']);
            await pool.promise().query(`REPLACE INTO Products (id, name, category, price, flash_sale_price, is_flash_sale, stock_quantity, is_active, expiry_date, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, ['2', 'Organic Hass Avocados (x2)', 'Produce', 4.00, null, 0, 15, 1, '2026-04-10', '["https://images.squarespace-cdn.com/content/v1/655a0aefcc06663665faecbe/62538653-2c3a-40a6-aa76-a8e612d8558c/img-6.jpg?format=1500w"]']);
            await pool.promise().query(`REPLACE INTO Products (id, name, category, price, flash_sale_price, is_flash_sale, stock_quantity, is_active, expiry_date, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, ['3', 'Natural Orange Wine 750ml', 'Wine', 22.50, null, 0, 8, 1, null, '["https://images.squarespace-cdn.com/content/v1/655a0aefcc06663665faecbe/031739f1-e709-4c7c-8a83-96ad1335265c/SUPER-CLUB.jpg?format=1500w"]']);
            await pool.promise().query(`REPLACE INTO Products (id, name, category, price, flash_sale_price, is_flash_sale, stock_quantity, is_active, expiry_date, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, ['4', 'Local Craft IPA 4-pack', 'Beer', 14.00, null, 0, 0, 1, '2026-08-01', '["https://images.squarespace-cdn.com/content/v1/655a0aefcc06663665faecbe/a79f2660-cd8a-4eae-ae3d-093081c594e8/LOOP-EVENTS.jpg?format=1500w"]']);
            await pool.promise().query(`REPLACE INTO Products (id, name, category, price, flash_sale_price, is_flash_sale, stock_quantity, is_active, expiry_date, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, ['5', 'Seasonal Organic Veg Box', 'Produce', 18.50, null, 0, 42, 1, '2026-03-30', '["https://images.squarespace-cdn.com/content/v1/655a0aefcc06663665faecbe/62538653-2c3a-40a6-aa76-a8e612d8558c/img-6.jpg?format=1500w"]']);
            await pool.promise().query(`REPLACE INTO Products (id, name, category, price, flash_sale_price, is_flash_sale, stock_quantity, is_active, expiry_date, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, ['6', 'Fresh Sourdough Loaf', 'Bakery', 5.50, null, 0, 12, 1, '2026-03-27', '["https://images.squarespace-cdn.com/content/v1/655a0aefcc06663665faecbe/0e3fab3d-6f56-42a3-8e68-afb7ed057815/stay-up.jpg?format=1500w"]']);
        }
